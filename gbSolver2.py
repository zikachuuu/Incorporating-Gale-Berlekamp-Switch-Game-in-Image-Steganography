...
initial_row_switches = [1, 1, 0]  # Initial state of row switches
initial_col_switches = [0, 0, 1]  # Initial state of column switches
lightGrid = [  
    [1, 1, 0],
    [0, 0, 1],
    [1, 0, 0]
...
matrix, result = GB_Solver2 (lightGrid , initial_col_switches , initial_row_switches, 3)
print (result)
